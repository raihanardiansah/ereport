...
return [
    ...
    | Jangan ragu untuk mengubah setiap pesan ini sesuai kebutuhan aplikasi Anda.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute yang diberikan terdeteksi dalam kebocoran data. Silakan pilih :attribute yang berbeda.',
    ],
    ...
    */
    ...
    'custom' => [
        'username' => [
            ...
            'regex' => 'Username hanya boleh berisi huruf kecil dan angka.',
        ],
        'email' => [
        ...
        'join_code' => [
            'required' => 'Kode sekolah wajib diisi.',
            'exists' => 'Kode sekolah tidak ditemukan atau tidak aktif.',
        ],
        'role' => [
        ...
        'school_name' => [
            ...
            'max' => 'Nama sekolah maksimal :max karakter.',
        ],
        'school_email' => [
            'required' => 'Email sekolah wajib diisi.',
            'email' => 'Format email sekolah tidak valid.',
            'unique' => 'Email sekolah sudah terdaftar.',
        ],
        'admin_name' => [
        ...
        'admin_email' => [
            ...
            'email' => 'Format email admin tidak valid.',
            'unique' => 'Email admin sudah terdaftar.',
        ],
        'admin_username' => [
            'required' => 'Username admin wajib diisi.',
            'unique' => 'Username admin sudah digunakan.',
            'min' => 'Username admin harus minimal :min karakter.',
            'regex' => 'Username hanya boleh berisi huruf kecil dan angka.',
        ],
        'admin_password' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut digunakan untuk mengganti placeholder :attribute
    | menjadi sesuatu yang lebih ramah pembaca seperti "Alamat E-Mail"
    | daripada "email".
    |
    */
