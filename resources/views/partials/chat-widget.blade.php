@if(auth()->check() && (auth()->user()->isAdminSekolah() || auth()->user()->hasRole('manajemen_sekolah')))
        ...
        <div id="chat-content" class="h-96 overflow-y-auto bg-gray-50 dark:bg-gray-900 custom-scrollbar relative">
            ...
            <div id="view-list" class="p-4 space-y-3">
                <div class="text-center mb-4">
                    ...
                    <a href="{{ route('contact.support') }}" class="text-xs text-primary-600 hover:text-primary-700 font-medium">Buat Tiket Baru</a>
                </div>
