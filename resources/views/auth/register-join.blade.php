<x-layouts.guest title="Gabung Sekolah">
    <!-- Header -->
    <div class="mb-6">
    ...
    <form method="POST" action="{{ route('register.join') }}" class="space-y-4">
        @csrf
        ...
        <div>
            ...
            <input type="text" id="join_code" name="join_code" value="{{ old('join_code', request('code')) }}"
                class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3CB371] focus:border-[#3CB371] transition-all text-sm uppercase @error('join_code') border-danger-500 @enderror"
        ...
        <div>
            ...
            <select id="role" name="role" required
                class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3CB371] focus:border-[#3CB371] transition-all text-sm @error('role') border-danger-500 @enderror">
        ...
        <div>
            ...
            <input type="text" id="name" name="name" value="{{ old('name') }}"
                class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3CB371] focus:border-[#3CB371] transition-all text-sm @error('name') border-danger-500 @enderror"
        ...
        <div>
            ...
            <input type="text" id="username" name="username" value="{{ old('username') }}"
                class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3CB371] focus:border-[#3CB371] transition-all text-sm lowercase @error('username') border-danger-500 @enderror"
        ...
        <div>
            ...
            <input type="text" id="nip_nisn" name="nip_nisn" value="{{ old('nip_nisn') }}"
                class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3CB371] focus:border-[#3CB371] transition-all text-sm @error('nip_nisn') border-danger-500 @enderror"
