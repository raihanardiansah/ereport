...
<head>
    <meta charset="utf-8">
    <title>Raport Perilaku Siswa</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="section">
        <div class="section-title">Ringkasan Perilaku</div>
        <table class="stats-grid">
            <tr>
                <td>
                    <div class="stats-number">{{ $stats['total_reports'] }}</div>
                    <div class="stats-label">Laporan Dikirim</div>
                </td>
                <td>
                    <div class="stats-number">{{ $stats['reports_about'] }}</div>
                    <div class="stats-label">Laporan Terkait</div>
                </td>
                <td>
    ...
    <div class="section">
        <div class="section-title">Riwayat Laporan Terkait Siswa</div>
