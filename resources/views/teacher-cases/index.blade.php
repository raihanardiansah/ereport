<x-layouts.app title="Penanganan Guru">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari kasus atau nama guru..."
            ...
            <div>
                <select name="priority" class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-primary-500">
                    ...
                    @foreach(\App\Models\TeacherCase::PRIORITIES as $key => $priority)
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="divide-y divide-gray-100">
            ...
            <a href="{{ route('teacher-cases.show', $case) }}" class="block p-5 hover:bg-gray-50 transition-colors">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-4 mt-2 text-sm text-gray-500">
                            <span class="flex items-center">
                                ...
                                {{ $case->teacher?->name ?? 'Belum ditentukan' }}
                            </span>
    ...
    <div id="createCaseModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <form method="POST" action="{{ route('teacher-cases.store') }}" class="p-6 space-y-4">
                @csrf
                <div>
