<x-layouts.app title="Buat Laporan">
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Isi formulir untuk membuat laporan</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-2xl">
        <form id="reportForm" method="POST" action="{{ route('reports.store') }}" enctype="multipart/form-data"
            ...
            @if(isset($reportableUsers) && $reportableUsers->count() > 0)
                <div class="relative">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Orang yang Dilaporkan <span class="text-gray-400 font-normal">(Opsional, bisa lebih dari
                            satu)</span>
                    </label>

                    <!-- Tag-style input container -->
                    <div id="accusedContainer"
                        class="w-full min-h-[48px] px-3 py-2 border border-gray-200 rounded-xl focus-within:ring-2 focus-within:ring-primary-500 focus-within:border-transparent bg-white">
                        <!-- Selected tags will appear here -->
                        <div id="selectedTags" class="flex flex-wrap gap-2 mb-2"></div>

                        <!-- Search input -->
                        <input type="text" id="accusedSearch" placeholder="Ketik nama untuk mencari..."
                            class="w-full border-0 focus:ring-0 p-0 text-sm placeholder-gray-400" autocomplete="off">
                    ...
                    <div id="accusedDropdown"
                        ...
                        @foreach($groupedUsers as $roleLabel => $users)
                            <div class="px-3 py-2 bg-gray-50 text-xs font-semibold text-gray-500 uppercase border-b">
                                {{ $roleLabel }}</div>
                            @foreach($users as $person)
                                <div class="accused-option px-4 py-2 hover:bg-primary-50 cursor-pointer flex items-center justify-between"
                                    data-id="{{ $person->id }}" data-name="{{ $person->name }}" data-role="{{ $roleLabel }}">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Kosongkan jika laporan bersifat umum (misal: kerusakan fasilitas).
                        Laporan umum tidak mempengaruhi indeks siapapun.</p>
            ...
            <div>
                ...
                <textarea id="content" name="content" rows="6" minlength="20" maxlength="2000" required
            ...
            <div>
                ...
                <div
                    ...
                    <label for="attachment" class="cursor-pointer">
                        ...
                        <p class="text-sm text-gray-500">JPG/PNG (maks 10MB, auto-kompres) atau PDF (maks 3MB)</p>
                    </label>
            ...
            <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                <label class="flex items-start cursor-pointer">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-sm text-amber-700 mt-1">Identitas Anda akan disembunyikan dari pihak sekolah.
                            Maksimal 2 laporan anonim per hari.</p>
                    </div>
                </label>
            ...
            <div class="flex items-center justify-end space-x-4 pt-4">
                <a href="{{ route('reports.index') }}" class="px-6 py-3 text-gray-600 hover:text-gray-800 font-medium"
                    id="cancel-btn">Batal</a>
            ...
            <div id="loading-overlay"
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-2xl max-w-sm w-full mx-4 text-center">
                    <div class="w-16 h-16 mx-auto mb-4 relative">
                        ...
                        <div
                            class="absolute inset-2 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-full flex items-center justify-center">
