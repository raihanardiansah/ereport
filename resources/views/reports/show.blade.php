                    ...
                    <form method="POST" action="{{ route('reports.comments.store', $report) }}" class="mb-4">
                        ...
                        <div class="space-y-3">
                            <textarea name="content" rows="2"
                                ...
                                class="w-full px-4 py-3 border border-amber-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-500 resize-none bg-white"></textarea>
                            <div class="flex justify-end">
                                <button type="submit"
                                    class="bg-amber-600 hover:bg-amber-700 text-white text-sm py-2 px-4 rounded-lg transition-colors">
                                    🔒 Simpan Catatan
                                </button>
                            </div>
                        </div>
