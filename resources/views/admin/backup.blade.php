<x-layouts.app title="Backup & Keamanan">
    <div class="mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <span class="font-bold text-gray-900">{{ $stats['total_schools'] }}</span>
                </div>
                <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <span class="font-bold text-gray-900">{{ $stats['total_reports'] }}</span>
                </div>
                <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <span class="text-gray-600">Total Pembayaran</span>
                    <span class="font-bold text-gray-900">{{ $stats['total_payments'] }}</span>
                </div>
                <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <span class="text-gray-600">Ukuran Database</span>
                    <span class="font-bold text-gray-900">{{ $stats['database_size'] }}</span>
                </div>
            </div>
        </div>
