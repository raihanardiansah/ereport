...
<div class="max-w-3xl mx-auto">
    ...
    <div class="card">
        <h1 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Edit Paket: {{ $package->name }}</h1>
        ...
        <form action="{{ route('admin.packages.update', $package) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-indigo-500 dark:bg-gray-800 dark:text-white resize-none">{{ old('description', $package->description) }}</textarea>
            </div>
            ...
            <div class="grid sm:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="max_users" value="{{ old('max_users', $package->max_users) }}" required min="1"
                        class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-indigo-500 dark:bg-gray-800 dark:text-white">
                </div>
                <div>
                    ...
                    <input type="number" name="max_reports_per_month" value="{{ old('max_reports_per_month', $package->max_reports_per_month) }}" required min="1"
                        class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-indigo-500 dark:bg-gray-800 dark:text-white">
                </div>
            </div>
            ...
            <div class="flex items-center space-x-6">
                ...
                <label class="flex items-center cursor-pointer">
                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $package->is_featured ?? false) ? 'checked' : '' }}
                        class="w-5 h-5 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
