                ...
                <div class="space-y-4">
                    <label class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <input type="checkbox" name="email_new_report" value="1" 
                            {{ $user->getEmailPreference('new_report') ? 'checked' : '' }}
                    ...
                    <label class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <input type="checkbox" name="email_status_update" value="1"
                            {{ $user->getEmailPreference('status_update') ? 'checked' : '' }}
                            class="w-5 h-5 text-primary-600 border-gray-300 rounded focus:ring-primary-500">
                    </label>
                    ...
                    <label class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <input type="checkbox" name="email_weekly_digest" value="1"
                            {{ $user->getEmailPreference('weekly_digest') ? 'checked' : '' }}
                            class="w-5 h-5 text-primary-600 border-gray-300 rounded focus:ring-primary-500">
                    </label>
                    ...
                    <label class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <input type="checkbox" name="email_comment_notification" value="1"
                            {{ $user->getEmailPreference('comment_notification') ? 'checked' : '' }}
                            class="w-5 h-5 text-primary-600 border-gray-300 rounded focus:ring-primary-500">
                    </label>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
            ...
            <div class="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                    ...
                    <p class="font-medium text-gray-900 dark:text-gray-100">{{ now()->translatedFormat('d F Y H:i') }}</p>
                </div>
                @if($user->school)
                <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg md:col-span-2">
                    ...
                    <p class="font-medium text-gray-900 dark:text-gray-100">{{ $user->school->name }}</p>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="mt-6">
            <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-xl p-6">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('school.profile') }}" class="inline-flex items-center px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors text-sm font-medium">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                        </svg>
                        Profil Sekolah
                    </a>
                    <a href="{{ route('subscriptions.index') }}" class="inline-flex items-center px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors text-sm font-medium">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
