...
<?php $component = App\View\Components\Layouts\Guest::resolve(['title' => 'Daftar Sekolah'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        <div class="pb-4 border-b border-gray-100">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="school_name" value="<?php echo e(old('school_name')); ?>" required maxlength="100"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php $__errorArgs = ['school_name'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="email" name="school_email" value="<?php echo e(old('school_email')); ?>" required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php $__errorArgs = ['school_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-danger-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="npsn" value="<?php echo e(old('npsn')); ?>" maxlength="20" pattern="[0-9]*"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php $__errorArgs = ['npsn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-danger-500 <?php unset($message);
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-danger-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="address" rows="2" maxlength="500"
                        ...
                        placeholder="Jl. Pendidikan No. 1"><?php echo e(old('address')); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="pt-2">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="admin_name" value="<?php echo e(old('admin_name')); ?>" required maxlength="50"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php $__errorArgs = ['admin_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-danger-500 <?php unset($message);
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="email" name="admin_email" value="<?php echo e(old('admin_email')); ?>" required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php $__errorArgs = ['admin_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-danger-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="admin_username" value="<?php echo e(old('admin_username')); ?>" required
                            minlength="8" maxlength="30" pattern="[a-z0-9]+"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php $__errorArgs = ['admin_username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-danger-500 <?php unset($message);
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="admin_password" id="admin_password" required minlength="8"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 pr-10 <?php $__errorArgs = ['admin_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-danger-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mt-6 text-center">
        <p class="text-gray-600">
            Sudah punya akun?
            <a href="<?php echo e(route('login')); ?>" class="text-primary-600 hover:text-primary-700 font-semibold">Login</a>
        </p>
    </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/auth/register-school.blade.php ENDPATH**/ ?>