...
<?php $component = App\View\Components\Layouts\App::resolve(['title' => 'Penanganan Siswa'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari kasus atau nama siswa..."
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="divide-y divide-gray-100">
            ...
            <a href="<?php echo e(route('student-cases.show', $case)); ?>" class="block p-5 hover:bg-gray-50 transition-colors">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-4 mt-2 text-sm text-gray-500">
                            <span class="flex items-center">
                                ...
                                <?php echo e($case->student->name ?? 'Unknown'); ?>
    ...
    <div id="createCaseModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <form method="POST" action="<?php echo e(route('student-cases.store')); ?>" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                <div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/student-cases/index.blade.php ENDPATH**/ ?>