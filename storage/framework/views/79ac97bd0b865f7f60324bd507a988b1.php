...
<body class="antialiased bg-slate-950 text-white">
    ...
    <section id="home" class="aurora-bg noise min-h-screen flex items-center relative">
        ...
        <!-- Grid Pattern -->
        <div
            class="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:64px_64px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,black_40%,transparent_100%)]">
        </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 lg:py-40">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <p class="text-xl text-white/80 mb-10 max-w-2xl mx-auto reveal">
                    Sistem manajemen laporan digital yang membantu sekolah memproses, melacak, dan menangani pelanggaran
                    siswa dengan efisien dan terstruktur.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center max-w-3xl mx-auto mb-20 reveal">
                <div class="inline-flex items-center px-4 py-2 glass-card rounded-full mb-6">
                    <span class="text-cyan-400 text-sm font-medium inline-flex items-center gap-1"><svg class="w-4 h-4"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg> Fitur Unggulan</span>
                </div>
            ...
            <div class="bento-grid">
                ...
                <div class="bento-item col-span-12 lg:col-span-8 glass-card rounded-3xl p-8 lg:p-12 reveal">
                    <div class="flex flex-col lg:flex-row gap-8">
                        <div class="flex-1">
                            <div
                                class="w-14 h-14 bg-gradient-to-br from-emerald-500 to-cyan-500 rounded-2xl flex items-center justify-center mb-6">
                            ...
                            <p class="text-white/70 text-lg mb-6">
                                Pantau semua laporan, tren pelanggaran, dan progress penanganan dalam satu dashboard
                                yang intuitif.
                            </p>
                            <div class="flex flex-wrap gap-3">
                                <span class="px-4 py-2 bg-white/5 rounded-lg text-sm text-gray-300">Grafik
                                    Interaktif</span>
                                <span class="px-4 py-2 bg-white/5 rounded-lg text-sm text-gray-300">Export PDF</span>
                                <span class="px-4 py-2 bg-white/5 rounded-lg text-sm text-gray-300">Filter
                                    Canggih</span>
                            </div>
                        </div>
                        <div
                            class="flex-1 rounded-2xl overflow-hidden shadow-2xl relative min-h-[300px] h-full group bg-black">
                ...
                <div class="bento-item col-span-12 lg:col-span-4 glass-card rounded-3xl p-8 reveal">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-white/70">Enkripsi end-to-end, backup otomatis, dan audit log untuk data yang aman.
                    </p>
                </div>
                ...
                <div class="bento-item col-span-12 sm:col-span-6 lg:col-span-4 glass-card rounded-3xl p-8 reveal">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-white/70">Super Admin, Admin Sekolah, Guru BK, dan Guru dengan akses yang berbeda.
                    </p>
                </div>
                ...
                <div class="bento-item col-span-12 sm:col-span-6 lg:col-span-4 glass-card rounded-3xl p-8 reveal">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-rose-500 to-pink-600 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bento-item col-span-12 sm:col-span-6 lg:col-span-4 glass-card rounded-3xl p-8 reveal">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-sky-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-white/70">Lacak progress setiap laporan dari laporan masuk hingga selesai ditangani.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="pricing" class="py-32 relative">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Trial Banner -->
            <div
                class="glass-card rounded-3xl p-8 mb-12 reveal border border-green-500/30 bg-gradient-to-r from-green-500/10 to-emerald-500/10">
                <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                    <div class="flex items-center gap-4">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl flex items-center justify-center text-3xl">
                        ...
                        <div>
                            ...
                            <p class="text-white/70">Akses semua fitur premium tanpa kartu kredit. Daftar sekarang dan
                                mulai transformasi sekolah Anda.</p>
                        </div>
                    </div>
                    <a href="/register"
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <?php $__empty_1 = true; $__currentLoopData = $packages ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <div
                        class="relative glass-card rounded-3xl p-8 reveal bento-item flex flex-col <?php echo e($isPopular ? 'border-2 border-cyan-500/50' : ''); ?>">
                        <?php if($isPopular): ?>
                            <div class="absolute -top-4 left-1/2 -translate-x-1/2">
                                <span
                                    class="bg-gradient-to-r from-emerald-500 to-cyan-500 text-white text-sm font-semibold px-4 py-1 rounded-full">
                                    Paling Populer
                                </span>
                            </div>
                        <?php endif; ?>
                        <div class="mb-6">
                            <h3 class="text-xl font-bold mb-2"><?php echo e($package->name); ?></h3>
                            <p class="text-white/70"><?php echo e($package->description); ?></p>
                        </div>
                        <div class="mb-6">
                            <?php if($package->price == 0): ?>
                                <span class="text-5xl font-bold">Gratis</span>
                            <?php else: ?>
                                <span class="text-5xl font-bold">Rp <?php echo e(number_format($package->price / 1000)); ?>K</span>
                                <span class="text-white/70">/bulan</span>
                            <?php endif; ?>
                        </div>
                        <ul class="space-y-4 mb-8 flex-grow">
                            <li class="flex items-center text-gray-300">
                                <svg class="w-5 h-5 text-green-400 mr-3 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7" />
                                </svg>
                                Hingga <?php echo e($package->max_users); ?> pengguna
                            </li>
                            <li class="flex items-center text-gray-300">
                                <svg class="w-5 h-5 text-green-400 mr-3 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                ...
                                <?php echo e($package->max_reports_per_month); ?> laporan/bulan
                            </li>
                        ...
                        <a href="/register"
                            class="block w-full <?php echo e($isPopular ? 'btn-glow' : 'glass-card hover:bg-white/10'); ?> text-center text-white font-semibold py-4 rounded-2xl transition-colors mt-auto">
                            <?php echo e($package->price == 0 ? 'Mulai Gratis' : 'Pilih Paket Ini'); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div
                        class="relative glass-card rounded-3xl p-8 reveal bento-item flex flex-col border-2 border-cyan-500/50">
                        <div class="absolute -top-4 left-1/2 -translate-x-1/2">
                            <span
                                class="bg-gradient-to-r from-emerald-500 to-cyan-500 text-white text-sm font-semibold px-4 py-1 rounded-full">
                                Paling Populer
                        ...
                        <a href="/register"
                            class="block w-full btn-glow text-center text-white font-semibold py-4 rounded-2xl mt-auto">
                            Pilih Paket Ini
                        </a>
                    </div>
                    <div class="glass-card rounded-3xl p-8 reveal bento-item flex flex-col">
    ...
    <section id="contact" class="py-32 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal">
                    <div class="inline-flex items-center px-4 py-2 glass-card rounded-full mb-6">
                        <span class="text-cyan-400 text-sm font-medium inline-flex items-center gap-1"><svg
                                class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg> Hubungi Kami</span>
                    </div>
                    <h2 class="text-4xl lg:text-5xl font-bold mb-6">
                    ...
                    <div class="space-y-6">
                        <a href="https://wa.me/628990772526" target="_blank"
                            class="flex items-center p-5 glass-card rounded-2xl hover:bg-white/5 transition-colors group">
                            <div
                                class="w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center mr-5">
                            ...
                            <svg class="w-5 h-5 text-gray-500 ml-auto group-hover:text-white group-hover:translate-x-1 transition-all"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <a href="mailto:support@ereport.systems"
                            class="flex items-center p-5 glass-card rounded-2xl hover:bg-white/5 transition-colors group">
                            <div
                                class="w-14 h-14 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl flex items-center justify-center mr-5">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2v10a2 2 0 002 2z" />
                                </svg>
                ...
                <div class="glass-card rounded-3xl p-8 lg:p-10 reveal">
                    ...
                    <form id="contact-form" class="space-y-6">
                        ...
                        <div class="grid sm:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Nama <span
                                        class="text-red-400">*</span></label>
                                <input type="text" name="name" required
                                    class="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white placeholder-gray-500"
                                    placeholder="Nama lengkap">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Email <span
                                        class="text-red-400">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-2">Pesan <span
                                    class="text-red-400">*</span></label>
                            <textarea rows="4" name="message" required
                                class="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white placeholder-gray-500 resize-none"
                                placeholder="Tulis pesan Anda..."></textarea>
                        </div>

                        <button type="submit" id="submit-btn"
                            class="w-full btn-glow text-white font-semibold py-4 rounded-xl">
    ...
    <footer class="py-16 border-t border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-gray-500">© <?php echo e(date('Y')); ?> e-Report. All rights reserved.</p>

                <div class="flex flex-col md:flex-row items-center gap-4">
                    <select id="language-selector" onchange="changeLanguage(this.value)"
                        class="bg-slate-900 border border-white/10 rounded-lg text-sm text-gray-400 focus:ring-emerald-500 focus:border-emerald-500 p-2 cursor-pointer">
...
</html><?php /**PATH /var/www/html/resources/views/landing.blade.php ENDPATH**/ ?>