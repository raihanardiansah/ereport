...
<head>
    ...
    <title>Print QR Code - <?php echo e($qrCode->location_name); ?></title>
...
<body class="bg-gray-100 min-h-screen flex flex-col items-center justify-center p-6">
    ...
    <div
        ...
        <div class="mb-6">
            <h2 class="text-xl font-bold text-gray-400 uppercase tracking-widest"><?php echo e($qrCode->school->name); ?></h2>
            <h1 class="text-3xl font-black text-gray-900 mt-2"><?php echo e($qrCode->location_name); ?></h1>
            <?php if($qrCode->default_category): ?>
                <span class="inline-block mt-2 px-3 py-1 bg-gray-100 rounded-full text-sm font-semibold text-gray-600">
                    Kategori: <?php echo e(ucfirst($qrCode->default_category)); ?>
        ...
        <div class="flex justify-center mb-6">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=<?php echo e($qrCode->url); ?>" alt="QR Code"
...
</html><?php /**PATH /var/www/html/resources/views/settings/qr-codes/print.blade.php ENDPATH**/ ?>