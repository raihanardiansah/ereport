...
<?php $component = App\View\Components\Layouts\App::resolve(['title' => 'Riwayat Pembayaran'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4">
                            <span class="font-mono text-sm font-medium text-gray-900"><?php echo e($transaction->order_id); ?></span>
                        </td>
                        ...
                        <td class="px-6 py-4 text-gray-900 text-sm">
                            <?php echo e($transaction->package->name ?? '-'); ?>

                        </td>
                        <td class="px-6 py-4 font-semibold text-gray-900 text-sm">
                            Rp <?php echo e(number_format($transaction->gross_amount, 0, ',', '.')); ?>
                        ...
                        <td class="px-6 py-4">
                            <?php if($transaction->transaction_status === 'pending'): ?>
                                <a href="<?php echo e(route('subscriptions.waiting', $transaction->order_id)); ?>" 
                            ...
                            <?php elseif(in_array($transaction->transaction_status, ['success', 'settlement'])): ?>
                                <button onclick="viewInvoice('<?php echo e($transaction->order_id); ?>')" 
                            ...
                            <?php elseif(in_array($transaction->transaction_status, ['expire', 'expired', 'cancel', 'deny'])): ?>
                                <button onclick="cancelTransaction('<?php echo e($transaction->order_id); ?>')" 
    ...
    <div class="mt-6">
        <a href="<?php echo e(route('subscriptions.index')); ?>" class="text-gray-600 hover:text-gray-800">
...
<?php /**PATH D:\laragon\www\E-Report\resources\views/subscriptions/history.blade.php ENDPATH**/ ?>