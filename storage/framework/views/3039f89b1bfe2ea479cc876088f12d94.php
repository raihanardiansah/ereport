...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a href="<?php echo e(route('subscriptions.packages')); ?>" class="btn-primary">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
            </svg>
            <?php echo e($currentSubscription ? 'Upgrade Paket' : 'Pilih Paket'); ?>
    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 card">
                ...
                <div class="flex items-start gap-6">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-2">
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($currentSubscription->package->name ?? 'Paket Tidak Tersedia'); ?></h3>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($currentSubscription->status_color); ?>">
                                <?php echo e(ucfirst($currentSubscription->status)); ?>

                            </span>
                        </div>
                        <p class="text-gray-600 dark:text-gray-400 mb-4"><?php echo e($currentSubscription->package->description ?? 'Paket langganan aktif'); ?></p>
                        
                        <!-- Progress Bar -->
                        <div class="mb-4">
                            <div class="flex justify-between text-sm mb-1">
                                <span class="text-gray-500 dark:text-gray-400">
                                    <?php echo e($currentSubscription->payment_method === 'trial' ? 'Sisa Masa Percobaan' : 'Masa aktif'); ?>

                                </span>
                                <span class="font-medium <?php echo e($subscriptionInfo['is_expiring_soon'] ? 'text-amber-600' : 'text-gray-700 dark:text-gray-300'); ?>">
                                    <?php echo e($subscriptionInfo['days_remaining']); ?> hari tersisa
                                </span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                                <div class="h-2.5 rounded-full <?php echo e($currentSubscription->payment_method === 'trial' ? 'bg-orange-500' : ($subscriptionInfo['is_expiring_soon'] ? 'bg-amber-500' : 'bg-indigo-600')); ?>" 
                                     style="width: <?php echo e($subscriptionInfo['progress_percent']); ?>%"></div>
                            </div>
                            <div class="flex justify-between text-xs text-gray-400 mt-1">
                                <span><?php echo e($currentSubscription->starts_at->format('d M Y')); ?></span>
                                <span><?php echo e($currentSubscription->expires_at->format('d M Y')); ?></span>
                            </div>
                        </div>

                        <?php if($subscriptionInfo['is_expiring_soon']): ?>
                            <div class="bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-xl p-3 mb-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-amber-700 dark:text-amber-400 text-sm font-medium">Langganan akan berakhir dalam <?php echo e($subscriptionInfo['days_remaining']); ?> hari!</span>
                                </div>
                            </div>
                        <?php endif; ?>

                        <?php if(!$currentSubscription->package): ?>
                        ...
                        <div class="flex flex-wrap gap-3">
                            <a href="<?php echo e(route('subscriptions.packages')); ?>" class="btn-primary text-sm">Perpanjang / Upgrade</a>
            ...
            <?php elseif($trialEligibility && $trialEligibility['is_eligible']): ?>
                <div class="flex items-start gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        <a href="<?php echo e(route('subscriptions.packages')); ?>" class="btn-primary text-sm">Ambil Trial Sekarang</a>
                    </div>
                </div>
            <?php else: ?>
                <div class="text-center py-8">
                    ...
                    <a href="<?php echo e(route('subscriptions.packages')); ?>" class="btn-primary">Pilih Paket</a>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="card">
            ...
            <?php if($currentSubscription && $currentSubscription->package): ?>
                <ul class="space-y-3">
                    <li class="flex items-center text-gray-600 dark:text-gray-400">
                        <svg class="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                        </svg>
                        Hingga <?php echo e($currentSubscription->package->max_users); ?> pengguna
                    </li>
                    <li class="flex items-center text-gray-600 dark:text-gray-400">
                        <svg class="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                        </svg>
                        <?php echo e($currentSubscription->package->max_reports_per_month); ?> laporan/bulan
                    </li>
                    <?php if($currentSubscription->package->features): ?>
                        <?php $__currentLoopData = $currentSubscription->package->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-center text-gray-600 dark:text-gray-400">
                                <svg class="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
    ...
    <div class="card">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('subscriptions.packages')); ?>" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">Lihat Semua →</a>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-4">
            <?php $__currentLoopData = $packages->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="border rounded-xl p-5 <?php echo e($pkg->is_featured ? 'border-indigo-500 ring-2 ring-indigo-500' : 'border-gray-200 dark:border-gray-700'); ?> relative">
                    <?php if($pkg->badge_text): ?>
                        <span class="absolute -top-3 left-4 px-3 py-1 text-xs font-semibold rounded-full bg-indigo-500 text-white">
                            <?php echo e($pkg->badge_text); ?>

                        </span>
                    <?php endif; ?>
                    <h3 class="font-semibold text-gray-900 dark:text-white"><?php echo e($pkg->name); ?></h3>
                    <p class="text-2xl font-bold text-indigo-600 dark:text-indigo-400 mt-2"><?php echo e($pkg->formatted_price); ?></p>
                    <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($pkg->duration_months); ?> bulan</p>
                    <a href="<?php echo e(route('subscriptions.checkout', $pkg)); ?>" class="block w-full text-center mt-4 <?php echo e($pkg->is_featured ? 'btn-primary' : 'btn-outline'); ?> text-sm py-2">
                        Pilih
                    </a>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if($paymentHistory->count() > 0): ?>
        <div class="card">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('subscriptions.history')); ?>" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">Lihat Semua →</a>
            </div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                <td class="py-3 font-mono text-sm text-gray-900 dark:text-white">
                                    <?php if($transaction->transaction_status === 'pending'): ?>
                                        <a href="<?php echo e(route('subscriptions.waiting', $transaction->order_id)); ?>" class="text-indigo-600 hover:text-indigo-800 hover:underline">
                                ...
                                <td class="py-3 text-gray-600 dark:text-gray-400"><?php echo e($transaction->created_at->format('d M Y')); ?></td>
                                <td class="py-3 font-medium text-gray-900 dark:text-white">Rp <?php echo e(number_format($transaction->gross_amount, 0, ',', '.')); ?></td>
                                <td class="py-3">
                                    <?php
                                    ...
                                    ?>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($statusConfig['class']); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/subscriptions/index.blade.php ENDPATH**/ ?>