...
<?php $component->withAttributes([]); ?>
    ...
    <!-- Filters -->
    <!-- Filters -->
    <div x-data="{ showAdvanced: <?php echo e(request('date_start') || request('date_end') || request('reporter_id') ? 'true' : 'false'); ?> }" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
        <form method="GET">
                ...
                <div class="flex gap-4">
                    <div class="w-40">
                        <select name="urgency" class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500">
                            ...
                            <option value="high" <?php echo e(request('urgency') == 'high' ? 'selected' : ''); ?>>⚠️ High</option>
            ...
            <div x-show="showAdvanced" class="pt-4 border-t border-gray-100 grid grid-cols-1 md:grid-cols-4 gap-4" style="display: none;">
                ...
                <div>
                    ...
                    <input type="date" name="date_start" value="<?php echo e(request('date_start')); ?>" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500">
                </div>
                <div>
                    <label class="block text-xs font-medium text-gray-500 mb-1">Sampai Tanggal</label>
                    <input type="date" name="date_end" value="<?php echo e(request('date_end')); ?>" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500">
                </div>
                ...
                <div>
                    ...
                    <select name="reporter_id" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500">
                        ...
                        <?php $__currentLoopData = $reporters ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reporter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($reporter->id); ?>" <?php echo e(request('reporter_id') == $reporter->id ? 'selected' : ''); ?>>
                                <?php echo e(Str::limit($reporter->name, 20)); ?> (<?php echo e($reporter->getRoleDisplayName()); ?>)
                            </option>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="divide-y divide-gray-100">
            ...
            <a href="<?php echo e(route('reports.show', $report)); ?>" class="block p-4 sm:p-6 hover:bg-gray-50 transition-colors">
                <!-- Desktop Layout -->
                <div class="hidden sm:flex sm:items-start sm:justify-between sm:gap-6">
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-3 mb-2">
                            <h3 class="font-semibold text-gray-900 text-base"><?php echo e($report->title); ?></h3>
                        ...
                        <div class="flex items-center gap-4 text-sm text-gray-500">
                            ...
                            <span class="inline-flex items-center">
                                <?php if($report->is_anonymous): ?>
                                    ...
                                    <?php if(auth()->id() === $report->user_id): ?>Anonim (Anda)<?php else: ?> Pengguna Anonim <?php endif; ?>
                                <?php else: ?>
                                    <img src="<?php echo e($report->user->avatar_url); ?>" 
                                         alt="<?php echo e($report->user->name); ?>" 
                                         class="w-5 h-5 rounded-full object-cover mr-2"
                                         onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($report->user->name)); ?>&color=7F9CF5&background=EBF4FF'">
                ...
                <div class="sm:hidden">
                    ...
                    <h3 class="font-semibold text-gray-900 mb-2"><?php echo e($report->title); ?></h3>
                    <p class="text-gray-600 text-sm line-clamp-2 mb-3"><?php echo e(Str::limit($report->content, 100)); ?></p>
                    <div class="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-gray-500">
                        ...
                        <span class="inline-flex items-center">
                            <?php if($report->is_anonymous): ?>
                                ...
                                <?php if(auth()->id() === $report->user_id): ?>Anda <?php else: ?> Anonim <?php endif; ?>
                            <?php else: ?>
                                <img src="<?php echo e($report->user->avatar_url); ?>" 
                                     alt="<?php echo e($report->user->name); ?>" 
                                     class="w-4 h-4 rounded-full object-cover mr-1"
                                     onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($report->user->name)); ?>&color=7F9CF5&background=EBF4FF'">
                                <?php echo e(Str::limit($report->user->name, 15)); ?>
