    ...
    <section id="pricing" class="py-32 relative">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                ?>
                <div class="relative glass-card rounded-3xl p-8 reveal bento-item flex flex-col <?php echo e($isPopular ? 'border-2 border-cyan-500/50' : ''); ?>">
                    <?php if($isPopular): ?>
                    ...
                    <a href="/register" class="block w-full <?php echo e($isPopular ? 'btn-glow' : 'glass-card hover:bg-white/10'); ?> text-center text-white font-semibold py-4 rounded-2xl transition-colors mt-auto">
...
<?php /**PATH D:\laragon\www\E-Report\resources\views/landing.blade.php ENDPATH**/ ?>