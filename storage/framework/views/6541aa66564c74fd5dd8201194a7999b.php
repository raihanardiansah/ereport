...
<?php $component = App\View\Components\Layouts\App::resolve(['title' => 'Kelola Pengguna'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('users.import')); ?>" class="btn-secondary inline-flex items-center">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/>
                </svg>
                Import CSV
            </a>
            <a href="<?php echo e(route('users.create')); ?>" class="btn-primary inline-flex items-center">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form method="GET" class="flex flex-col sm:flex-row gap-4">
            ...
            <div class="sm:w-48">
                <select name="role" class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500">
                    ...
                    <option value="manajemen_sekolah" <?php echo e(request('role') == 'manajemen_sekolah' ? 'selected' : ''); ?>>Manajemen Sekolah</option>
                    <option value="staf_kesiswaan" <?php echo e(request('role') == 'staf_kesiswaan' ? 'selected' : ''); ?>>Staf Kesiswaan</option>
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6 mb-8">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-bold text-yellow-800 flex items-center">
                ...
                Menunggu Persetujuan (<?php echo e($pendingUsers->count()); ?>)
            </h2>
        </div>
        ...
        <div class="bg-white rounded-lg border border-yellow-100 overflow-hidden">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__currentLoopData = $pendingUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <span class="h-8 w-8 rounded-full bg-gray-100 flex items-center justify-center text-xs font-bold mr-3">
                                    <?php echo e(substr($pUser->name, 0, 1)); ?>

                                </span>
                                <div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($pUser->name); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($pUser->email); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                <?php echo e($pUser->getRoleDisplayName()); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-500">
                            <?php echo e($pUser->created_at->diffForHumans()); ?>

                        </td>
                        <td class="px-6 py-4 text-right space-x-2">
                            <form action="<?php echo e(route('users.approve', $pUser)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
                            ...
                            <form action="<?php echo e(route('users.reject', $pUser)); ?>" method="POST" class="inline" onsubmit="return confirm('Tolak dan hapus data pendaftar ini?')">
                                <?php echo csrf_field(); ?>
            ...
            <div class="p-4">
                <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center min-w-0">
                        ...
                        <div class="min-w-0">
                            <p class="font-medium text-gray-900 truncate"><?php echo e($user->name); ?></p>
                    ...
                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium shrink-0 ml-2
                        <?php if($user->role === 'manajemen_sekolah'): ?> bg-purple-100 text-purple-700
                        <?php elseif($user->role === 'staf_kesiswaan'): ?> bg-blue-100 text-blue-700
                        <?php elseif($user->role === 'guru'): ?> bg-green-100 text-green-700
                ...
                <div class="flex items-center justify-between text-sm">
                    <div class="text-gray-500">
                        <span class="font-mono"><?php echo e($user->username); ?></span>
                        <?php if($user->nip_nisn): ?>
                            <span class="mx-1">•</span>
                            <span><?php echo e($user->nip_nisn); ?></span>
                        <?php endif; ?>
                    </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <span class="text-gray-900 font-mono text-sm"><?php echo e($user->username); ?></span>
                        </td>
                        <td class="px-6 py-4">
