<?php $__env->startSection('title', 'Langganan Berakhir'); ?>
...
<div class="min-h-[60vh] flex items-center justify-center">
    <div class="max-w-lg w-full mx-auto">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
            <!-- Icon -->
            <div class="w-20 h-20 mx-auto mb-6 <?php echo e($isAdmin ?? false ? 'bg-amber-100 dark:bg-amber-900/30' : 'bg-red-100 dark:bg-red-900/30'); ?> rounded-full flex items-center justify-center">
                <svg class="w-10 h-10 <?php echo e($isAdmin ?? false ? 'text-amber-500' : 'text-red-500'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="<?php echo e(route('subscriptions.index')); ?>" class="btn-secondary">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                <a href="<?php echo e(route('profile.show')); ?>" class="btn-secondary">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-sm text-gray-500 dark:text-gray-400 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                <p>Sekolah: <span class="font-medium text-gray-700 dark:text-gray-300"><?php echo e(auth()->user()->school->name); ?></span></p>
            </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\E-Report\resources\views/dashboard/expired.blade.php ENDPATH**/ ?>