<?php $__env->startSection('title', 'Hubungi Support'); ?>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="space-y-4">
                        <a href="<?php echo e($whatsAppLink); ?>" target="_blank" class="flex items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-xl hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors group">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-green-600 dark:text-green-400"><?php echo e($supportWhatsApp); ?></p>
                            </div>
                        ...
                        <a href="mailto:<?php echo e($supportEmail); ?>" class="flex items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors group">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-600 dark:text-blue-400"><?php echo e($supportEmail); ?></p>
                            </div>
    ...
    <?php if($myMessages->count() > 0): ?>
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <?php $__currentLoopData = $myMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card <?php echo e($msg->status === 'replied' ? 'border-l-4 border-green-500' : ($msg->status === 'unread' ? 'border-l-4 border-yellow-500' : '')); ?>">
                        <div class="flex items-start justify-between mb-2">
                            <span class="font-medium text-gray-900 dark:text-white"><?php echo e($msg->subject ?: $msg->type_label); ?></span>
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium <?php echo e($msg->status_color); ?>">
                                <?php echo e($msg->status_label); ?>

                            </span>
                        </div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2 mb-2"><?php echo e(Str::limit($msg->message, 80)); ?></p>
                        <p class="text-xs text-gray-400 dark:text-gray-500 mb-3"><?php echo e($msg->created_at->format('d M Y, H:i')); ?></p>
                        
                        <button onclick="openChatWidgetThread(<?php echo e($msg->id); ?>)" class="w-full py-2 bg-gray-50 hover:bg-gray-100 text-gray-600 text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\E-Report\resources\views/contact/support.blade.php ENDPATH**/ ?>