...
<head>
    ...
    <title><?php echo e($title ?? 'Dashboard'); ?> - e-Report</title>
...
<body class="antialiased bg-gray-100 overflow-x-hidden" data-user-role="<?php echo e(auth()->user()->role); ?>">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto custom-scrollbar">
                ...
                <div class="space-y-1">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors <?php echo e(request()->routeIs('dashboard*') ? 'bg-gray-800 text-white' : ''); ?>">
                    ...
                    <?php else: ?>
                    <!-- Reports -->
                    <a href="<?php echo e(route('reports.index')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors <?php echo e(request()->routeIs('reports*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if(auth()->user()->hasAnyRole(['admin_sekolah'])): ?>
                    <!-- User Management -->
                    <a href="<?php echo e(route('users.index')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors <?php echo e(request()->routeIs('users*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if(auth()->user()->hasAnyRole(['admin_sekolah', 'manajemen_sekolah'])): ?>
                    <!-- Analytics -->
                    <a href="<?php echo e(route('analytics.index')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if(auth()->user()->hasAnyRole(['admin_sekolah', 'manajemen_sekolah', 'staf_kesiswaan'])): ?>
                    <!-- Student Cases -->
                    <a href="<?php echo e(route('student-cases.index')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors <?php echo e(request()->routeIs('student-cases*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if(auth()->user()->hasAnyRole(['admin_sekolah', 'manajemen_sekolah'])): ?>
                    <!-- Teacher Cases -->
                    <a href="<?php echo e(route('teacher-cases.index')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors <?php echo e(request()->routeIs('teacher-cases*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Leaderboard -->
                    <?php if(auth()->user()->isAdminSekolah() || auth()->user()->isManajemenSekolah() || auth()->user()->isTeacher() || auth()->user()->isSiswa()): ?>
                    <a href="<?php echo e(route('leaderboard.index')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors <?php echo e(request()->routeIs('leaderboard*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="pt-4 mt-4 border-t border-gray-800">
                        ...
                        <a href="<?php echo e(route('admin.analytics')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                            </svg>
                            Analytics Platform
                        ...
                        <a href="<?php echo e(route('admin.schools')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.student-cases')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.messages')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php if($unreadMsgCount > 0): ?>
                                <span class="ml-auto bg-red-500 text-white text-xs rounded-full px-2 py-0.5"><?php echo e($unreadMsgCount); ?></span>
                            <?php endif; ?>
                        </a>

                        <a href="<?php echo e(route('admin.packages')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.audit-logs')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.backup')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="pt-4 mt-4 border-t border-gray-800">
                        ...
                        <a href="<?php echo e(route('school.profile')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                            </svg>
                            Profil Sekolah
                        ...
                        <a href="<?php echo e(route('settings.auto-assignment')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors <?php echo e(request()->routeIs('settings.auto-assignment*') ? 'bg-gray-800 text-white' : ''); ?>">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('settings.qr-codes.index')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors <?php echo e(request()->routeIs('settings.qr-codes*') ? 'bg-gray-800 text-white' : ''); ?>">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4m0 1a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1z M14 4m0 1a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1z M4 14m0 1a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1z M14 17h6 M17 14v6"/>
                            </svg>
                            QR Codes
                        </a>

                        <a href="<?php echo e(route('subscriptions.index')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('contact.support')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="pt-4 mt-4 border-t border-gray-800">
                        <a href="<?php echo e(route('audit.index')); ?>" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors <?php echo e(request()->routeIs('audit.*') ? 'bg-gray-800 text-white' : ''); ?>">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            Audit Trail
                    ...
                    <nav class="hidden sm:flex items-center space-x-2 text-sm">
                        ...
                        <?php if(isset($breadcrumbs)): ?>
                            <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($crumb['url']); ?>" class="text-gray-500 hover:text-gray-700"><?php echo e($crumb['label']); ?></a>
                                <?php endif; ?>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" id="notification-wrapper">
                            <button onclick="toggleNotifications()" class="relative p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
                                ...
                                <span class="absolute top-1 right-1 min-w-[18px] h-[18px] flex items-center justify-center text-xs font-bold text-white bg-danger-500 rounded-full px-1"><?php echo e($unreadCount > 9 ? '9+' : $unreadCount); ?></span>
                                <?php endif; ?>
                            </button>
                            ...
                            <div id="notification-menu" class="hidden absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-100 overflow-hidden z-50">
                                ...
                                <div class="max-h-80 overflow-y-auto">
                                    ...
                                    <a href="<?php echo e($notification->data['report_id'] ?? null ? route('reports.show', $notification->data['report_id']) : '#'); ?>" 
                                       class="block px-4 py-3 hover:bg-gray-50 <?php echo e($notification->isRead() ? '' : 'bg-blue-50'); ?>">
                                ...
                                <a href="<?php echo e(route('notifications.index')); ?>" class="block px-4 py-3 text-center text-sm text-primary-600 hover:bg-gray-50 border-t border-gray-100">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div id="user-menu" class="hidden absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-100 dark:border-gray-700 py-1 z-50">
                                ...
                                <a href="<?php echo e(route('profile.show')); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <a href="<?php echo e(route('settings')); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <svg class="w-4 h-4 mr-3 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    </svg>
                                ...
                                <?php if(auth()->user()->isAdminSekolah()): ?>
                                <a href="<?php echo e(route('school.profile')); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <svg class="w-4 h-4 mr-3 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                    </svg>
                                    Profil Sekolah
    ...
    <script>
        ...
        let lastNotificationCount = <?php echo e($unreadCount ?? 0); ?>;
